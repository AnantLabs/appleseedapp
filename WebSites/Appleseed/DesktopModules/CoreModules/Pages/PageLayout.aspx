...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <table border="0" cellpadding="2" cellspacing="1" class="ModuleWrap">
        ...
        <tr>
            <td>
                <asp:Button runat="server" id="showHidebutton1" Text="Hide Settings" OnClientClick="runEffect('1','Settings');return false;" />
                <asp:HiddenField runat="server" id="showHideHidden1" Value="hide" />
            </td>
        </tr>
        <% } %>
        <tr>
        ...
        <tr>
            <td>
                <asp:Button ID="showHidebutton2" runat="server" Text="Hide Modules" OnClientClick="runEffect('2','Modules');return false;" />
                 <asp:HiddenField runat="server" id="showHideHidden2" Value="hide" />
            </td>
        </tr>
        <% } %>
        <tr>
        ...
        <script type="text/javascript">
           function runEffect(id,name) {
               ...
               var options = {};
                ...
                // run the effect
               $("#toggler" + id).toggle(selectedEffect, options, 200);
               if($('#Content_showHideHidden'+id).attr('value')=="hide"){
                   $('#Content_showHideHidden' + id).attr('value', "show");
                   $('#Content_showHidebutton' + id).attr('value', "Show "+ name);
               }
               else{
                   $('#Content_showHideHidden' + id).attr('value', "hide");
                   $('#Content_showHidebutton' + id).attr('value', "Hide " + name);
               }
