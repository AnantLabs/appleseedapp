...
namespace Appleseed.DesktopModules.CoreModules.HTMLContent
{
    using System;
    ...
    public partial class HtmlModule : PortalModuleControl, IModuleExportable
    {
        ...
        /// </summary>
        private const string StringsCompareButton = "MODULESETTINGS_HTMLCONTENT_SHOW_COMPARE_BUTTON";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.EditUrl = "~/DesktopModules/CoreModules/HTMLContent/HtmlEdit.aspx";
            ...
            if (PortalSecurity.HasEditPermissions(this.ModuleID)) {
                ...
                var url = HttpUrlBuilder.BuildUrl("~/DesktopModules/CoreModules/HTMLContent/HtmlEditModal.aspx?mID="+this.ModuleID);
